...
const { manageChat, sendMessage, getChatters } = require("./utils.js");
...
sendMessage(null, config.botName, null, "Chat iniciado");
...
$("#button-send").click(() => {
  ...
  // render message
  sendMessage(null, config.channels[0], null, msg);
  // send message
